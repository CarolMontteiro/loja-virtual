...
<section id="identification" class="pb-20">
    <div class="container">
        ...
        <form class="bg-white py-10 md:flex md:justify-between">
            <div class="create-account text-center border-b-2 pb-10 md:border-r-2 md:border-b-0 md:w-1/2 ">
                <h2 class="text-blue-800 text-xl text-center font-semibold pb-6 md:pb-10 md:text-2xl">Crie uma conta</h2>
                <fieldset class="w-4/5 mx-auto sm:w-3/5">
                    <label for="email-acconunt" class="text-lg pb-1 mr-2 text-gray-600 text-start block">Email</label>
                    <input type="email" id="email-acconunt" class="required w-full border-2 rounded-lg p-1.5 outline-none">
            ...
            <div class="login text-center md:w-1/2">
                ...
                <fieldset class="w-4/5 mx-auto sm:w-3/5">
                    ...
                    <input type="text" id="email-login" class="required w-full border-2 rounded-lg mb-6 p-1.5 outline-none">
                    <span class="span-required"></span>
                </fieldset>

                <fieldset class="w-4/5 mx-auto sm:w-3/5">
                    <label for="password" class="text-lg pb-1 mr-2 text-gray-600 text-start block">Senha</label>
                    <input type="password" id="password" class="required w-full border-2 rounded-lg mb-3 p-1.5 outline-none">
                    <span class="span-required"></span>
                </fieldset>
